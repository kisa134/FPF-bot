...
from .policy import FINISH, SYSTEM_PROMPT, Move, _prompt, with_rationale
...
class OpenAICompatPolicy:
    ...
    def choose(
        ...
        *,
        ...
        tools = [
            {
                ...
                "function": {
                    ...
                    "parameters": with_rationale(_SCHEMAS[KIND_TO_TOOL[k]]),
                },
            }
            ...
            tools.append(
                {
                    ...
                    "function": {
                        ...
                        "parameters": with_rationale({"type": "object", "properties": {}}),
                    },
                }
            )
        ...
        self.last_rationale = raw.pop("rationale", None)
